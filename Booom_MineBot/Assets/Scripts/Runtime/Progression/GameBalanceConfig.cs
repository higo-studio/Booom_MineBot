...
namespace Minebot.Progression
{
    ...
    public sealed class GameBalanceConfig : ScriptableObject
    {
        ...
        [SerializeField]
        private int firstUpgradeThreshold = 5;

        [SerializeField]
        private ResourceAmount startingResources = new ResourceAmount(0, 3, 0);

        [SerializeField]
        private ResourceAmount repairCost = new ResourceAmount(2, 0, 0);

        [SerializeField]
        private ResourceAmount robotCost = new ResourceAmount(5, 0, 0);
