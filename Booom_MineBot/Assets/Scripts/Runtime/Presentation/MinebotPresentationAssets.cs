...
namespace Minebot.Presentation
{
    public sealed class MinebotPresentationAssets
    {
        ...
        public GameObject ExplosionParticlePrefab { get; private set; }
        ...
        public static MinebotPresentationAssets Create(MinebotPresentationArtSet artSet, DualGridTerrainProfile dualGridProfileOverride)
        {
            ...
            var assets = new MinebotPresentationAssets
            {
                ...
                ExplosionParticlePrefab = resolvedArtSet != null ? resolvedArtSet.CellFxResources.ExplosionParticlePrefab : missingDefaults.ExplosionParticlePrefab,
                ...
                TransitionMaterial = resolvedArtSet?.TransitionMaterial,
                TransitionDuration = resolvedArtSet?.TransitionDuration ?? 1f
            };
